...
<p>These values must be larger than the size of your lapineddukddakbox file.</p>
...
<h3>Upload lapineddukddakbox.lua</h3>
...
<h3>Current Count</h3>
<p>There are currently <?php echo number_format(count($return)) ?> synthesis in the database</p>
