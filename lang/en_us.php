...
return array(	
	...
	'MapsDBLabel'						=>	'Maps Database',
	'ScriptMobsFoundedLabel'			=>	'Mobs in database: <span id="monNum">%d</span>',
	'ScriptNpcsFoundedLabel'			=>	'NPCs in database: <span id="npcNum">%d</span>',
	'ScriptShopsFoundedLabel'			=>	'Shops in database: <span id="shopNum">%d</span>',
	'ScriptWarpsFoundedLabel'			=>	'Warps in database: <span id="warpNum">%d</span>',
	'ScriptMapsFoundedLabel'			=>	'Maps in database: <span id="mapNum">%d</span>',
	'ScriptMapflagsFoundedLabel'		=>	'Mapflags in database: <span id="mapflagNum">%d</span>',
	'ScriptUploadScriptLabel'			=>	'<br>Add to archive folder <b>*npc</b> and upload it<br>Max size file upload: %d</b> MB',
	'ScriptUploadMapLabel'				=>	'<br>Upload file  <b>*map_cache.dat</b><br>Max size file upload: %d</b> MB',
	'ScriptCleanUnitsLabel'				=>	'Clean Units Database',
	'ScriptCleanUnitsConfirmLabel'		=>	'Are you sure you want to clean units database?',
	'ScriptCleanUnitsCleanLabel'		=>	'Units database successfully cleaned',
	'ScriptCleanUnitsAddedLabel'		=>	'Successfull load %d files',
	'ScriptCleanMapsLabel'				=>	'Clean Maps Database',
	'ScriptCleanMapsConfirmLabel'		=>	'Are you sure you want to clean maps database?',
	'ScriptCleanMapsCleanLabel'			=>	'Maps database successfully cleaned',
	'ScriptCleanMapsAddedLabel'			=>	'Maps successfully added to database. Total maps - %d',
	'ScriptError1Label'					=>	'File is not map_cache.dat',
	'ScriptError2Label'					=>	'File map_cache.dat not validate',
	'ScriptError3Label'					=>	'File must be ZIP ARCHIVE',
	'ScriptError4Label'					=>	'Files in the archive not found',
	
	// Search
	'SearchMapDBLabel'					=>	'Map',
	'SearchMapNameDBLabel'				=>	'Map name',
	'SearchNameDBLabel'					=>	'Name',
	'SearchTypeDBLabel'					=>	'Type',
	'AllTypeDBLabel'					=>	'All',
	'NpcTypeDBLabel'					=>	'NPC',
	'ShopTypeDBLabel'					=>	'Shop',
	'CoordinatesDBLabel'				=>	'Coordinates',
	'SearchBtnDBLabel'					=>	'Search',
	'ResetBtnDBLabel'					=>	'Reset',
	'MapsNotFoundDBLabel'				=>	'Maps not found.',
	'NpcsNotFound2DBLabel'				=>	'NPC not found.',
	'NpcsNotFoundDBLabel'				=>	'No NPCs found.',
	'GoBackLabel'						=>	'Go back',
	'EALabel'							=>	'ea.',
	'MinuteLabel'						=>	'min',

	// Map module
	'MapsDBLabel'						=>	'Map Database',
	'MobsOnMapDBLabel'					=>	'Monsters on map',
	'NoMobsOnMapDBLabel'				=>	'No monsters on this map.',
	'NpcsOnMapDBLabel'					=>	'NPCs on map',
	'NoNpcsOnMapDBLabel'				=>	'No NPCs on this map.',
	'ShopsOnMapDBLabel'					=>	'Shops on map',
	'NoShopsOnMapDBLabel'				=>	'No Shops on this map.',
	'MapflagsMapDBLabel'				=>	'Mapflags on map',
	
	// NPC module
	'NpcsDBLabel'						=>	'NPC List',
	'NpcsViewLabel'						=>	'Viewing NPC',
	'NpcsType0Label'					=>	'NPC',
	'NpcsType1Label'					=>	'Shop',
	'NpcsSaleListLabel'					=>	'Items for sale',
	
	// Mapflags description
	'Mapflag_noreturn'						=>	'Disables usage of map-warping items such as Butterfly Wing.',
	'Mapflag_noteleport'					=>	'Disables all means of teleportation within the map.',
	'Mapflag_nowarp'						=>	'Disables warping from a map.',
	'Mapflag_nowarpto'						=>	'Disables warping to a map.',
	'Mapflag_nogo'							=>	'Disables usage of command @go on a map.',
	'Mapflag_nosave'						=>	'Disables auto-saving on a map.',
	'Mapflag_nomemo'						=>	'Disables the /memo command to save a warp point, and usage of marriage skills.',
	'Mapflag_noitemconsumption'				=>	'Disables usage of items.',
	'Mapflag_notrade'						=>	'Disables trading of items and zeny.',
	'Mapflag_nodrop'						=>	'Disables dropping of items.',
	'Mapflag_noloot'						=>	'Disables normal monsters and MVPs from dropping of items.',
	'Mapflag_nomobloot'						=>	'Disables normal monsters from dropping of items.',
	'Mapflag_nomvploot'						=>	'Disables MVPs monsters from dropping of items.',
	'Mapflag_noexp'							=>	'Disables gaining base and job experience from monsters including MVP bonuses.',
	'Mapflag_nobaseexp'						=>	'Disables gaining base experience from monsters including MVP bonuses.',
	'Mapflag_nojobexp'						=>	'Disables gaining job experience from monsters including MVP bonuses.',
	'Mapflag_nopenalty'						=>	'Disables the loss of experience and Zeny upon death.',
	'Mapflag_noexppenalty'					=>	'Disables the loss of experience upon death.',
	'Mapflag_nozenypenalty'					=>	'Disables the loss of Zeny upon death.',
	'Mapflag_nochat'						=>	'Disables chatroom creation.',
	'Mapflag_novending'						=>	'Disables shop creation.',
	'Mapflag_nousecart'						=>	'Disables cart usage.',
	'Mapflag_noskill'						=>	'Disables skill usage.',
	'Mapflag_restricted'					=>	'Disables certain items and skills.',
	'Mapflag_monster_noteleport'			=>	'Prevents monsters from teleporting.',
	'Mapflag_nobranch'						=>	'Disables usage of monster-spawning items such as Dead Branch.',
	'Mapflag_noicewall'						=>	'Disables usage of skill <b>Ice wall</b>.',
	'Mapflag_nosunmoonstarmiracle'			=>	'Disables Star Gladiator\'s "Solar, Lunar, and Stellar Miracle" from occurring.',
	'Mapflag_nomineeffect'					=>	'Disables mine effects.',
	'Mapflag_nolockon'						=>	'Disables attacking another player without holding shift or using /ns.',
	'Mapflag_nocommand'						=>	'Disables everyone to use commands.',
	'Mapflag_pvp'							=>	'Enables Player vs. Player mode and applies the corresponding damage adjustments.',
	'Mapflag_pvp_noparty'					=>	'Enables Player vs. Player mode and applies the corresponding damage adjustments which ignores party alliances.',
	'Mapflag_pvp_noguild'					=>	'Enables Player vs. Player mode and applies the corresponding damage adjustments which ignores guild alliances.',
	'Mapflag_pvp_nocalcrank'				=>	'Enables Player vs. Player mode and applies the corresponding damage adjustments where calculation of PvP rankings is disabled.',
	'Mapflag_pvp_nightmaredrop'				=>	'Causes players to drop items upon death.',
	'Mapflag_gvg'							=>	'Enables Guild vs. Guild mode and applies the corresponding damage adjustments.',
	'Mapflag_gvg_noparty'					=>	'Enables Guild vs. Guild mode and applies the corresponding damage adjustments which ignores party alliances.',
	'Mapflag_gvg_castle'					=>	'Marks the map as guild castle, enables Guild vs. Guild mode, and applies the corresponding damage adjustments.',
	'Mapflag_gvg_dungeon'					=>	'Marks the map as guild dungeon, enables Guild vs. Guild mode, players return to save point after two death, and applies the corresponding damage adjustments (guild dungeon).',
	'Mapflag_gvg_te'						=>	'Enables Guild vs. Guild TE mode and applies the corresponding damage adjustments.',
	'Mapflag_gvg_te_castle'					=>	'Marks the map as TE guild castle, enables Guild vs. Guild mode, and applies the corresponding damage adjustments.',
	'Mapflag_battleground'					=>	'Enables Battlegrounds and applies the corresponding damage adjustments.',
	'Mapflag_partylock'						=>	'Prevents alteration of parties such as creating, leaving, inviting, expelling, breaking, and changing leaders. However, party is still allowed to change party options.',
	'Mapflag_guildlock'						=>	'Prevents alteration of guilds such as creating, leaving, inviting, expelling, breaking, and changing leaders. Also, it blocks changes to guild alliances.',
	'Mapflag_skill_damage'					=>	'Some skills damage adjustments is in-effect.',
	'Mapflag_skill_duration'				=>	'Some skills duration adjustments is in-effect.',
	'Mapflag_clouds'						=>	'Map have clouds effect.',
	'Mapflag_clouds2'						=>	'Map have clouds effect.',
	'Mapflag_fireworks'						=>	'Map have fireworks effect.',
	'Mapflag_fog'							=>	'Map have fog effect.',
	'Mapflag_leaves'						=>	'Map have leaves effect.',
	'Mapflag_sakura'						=>	'Map have sakura effect.',
	'Mapflag_snow'							=>	'Map have snow effect.',
	'Mapflag_nightenabled'					=>	'Night mode effects enabled.',
	'Mapflag_town'							=>	'Marks a map as a town.',
	'Mapflag_reset'							=>	'Allows usage of item Neuralizer.',
	'Mapflag_bexp'							=>	'Have a custom base experience rate.',
	'Mapflag_jexp'							=>	'Have a custom job experience rate.',
	'Mapflag_loadevent'						=>	'Triggers the label "OnPCLoadMapEvent" when players enter a map.',
	'Mapflag_allowks'						=>	'Allows kill stealing.',
	'Mapflag_autotrade'						=>	'Allows players to use @autotrade command if possible/available.',
	'Mapflag_nomapchannelautojoin'			=>	'Stops players from automatically joining the #map channel.',
	'Mapflag_notomb'						=>	'Disables MVP tombs from appearing.',
	'Mapflag_nocostume'						=>	'Disables costume sprites.',
