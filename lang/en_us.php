...
return array(	
	...
	// Scripts parser
	'SpawnGeneratorLabel'				=>	'Script and map parser',
	...
	'MapflagsMapDBLabel'				=>	'Mapflags of this map.',
	...
	'Mapflag_noreturn'						=>	'Disabled usage of map-warping items on a map.',
	'Mapflag_noteleport'					=>	'Disabled all means of teleportation within a map.',
	'Mapflag_nowarp'						=>	'Disabled warping from a map.',
	'Mapflag_nowarpto'						=>	'Disabled warping to a map.',
	'Mapflag_nogo'							=>	'Disabled usage of command @go on a map.',
	'Mapflag_nosave'						=>	'Disabled auto-saving on a map.',
	'Mapflag_nomemo'						=>	'Disabled the /memo command to save a warp point on a map, and also disabled usage of marriage skills.',
	'Mapflag_noitemconsumption'				=>	'Disabled usage of items on a map.',
	'Mapflag_notrade'						=>	'Disabled trading on a map.',
	'Mapflag_nodrop'						=>	'Disabled dropping items on a map.',
	'Mapflag_noloot'						=>	'Disabled normal monsters and MVPs from dropping items on a map.',
	'Mapflag_nomobloot'						=>	'Disabled normal monsters from dropping items on a map.',
	'Mapflag_nomvploot'						=>	'Disabled MVPs monsters from dropping items on a map.',
	'Mapflag_noexp'							=>	'Disabled gaining base and job experience from monsters, including MVP bonuses, on a map.',
	'Mapflag_nobaseexp'						=>	'Disabled gaining base experience from monsters, including MVP bonuses, on a map.',
	'Mapflag_nojobexp'						=>	'Disabled gaining job experience from monsters, including MVP bonuses, on a map.',
	'Mapflag_nopenalty'						=>	'Disabled the loss of experience and Zeny upon death on a map.',
	'Mapflag_noexppenalty'					=>	'Disabled the loss of experience upon death on a map.',
	'Mapflag_nozenypenalty'					=>	'Disabled the loss of Zeny upon death on a map.',
	'Mapflag_nochat'						=>	'Disabled chatroom creation on a map.',
	'Mapflag_novending'						=>	'Disabled shop creation on a map.',
	'Mapflag_nousecart'						=>	'Disabled cart usage on a map.',
	'Mapflag_noskill'						=>	'Disabled skill usage on a map.',
	'Mapflag_restricted'					=>	'Disabled certain items and skills on a map.',
	'Mapflag_monster_noteleport'			=>	'Prevents monsters from teleporting on a map.',
	'Mapflag_nobranch'						=>	'Disabled usage of monster-spawning items on a map.',
	'Mapflag_noicewall'						=>	'Disabled skill <b>Ice wall</b> on a map.',
	'Mapflag_nosunmoonstarmiracle'			=>	'Disabled Star Gladiator\'s "Solar, Lunar, and Stellar Miracle" from occurring on a map.',
	'Mapflag_nomineeffect'					=>	'Disabled mine effects on a map.',
	'Mapflag_nolockon'						=>	'Disabled attacking another player without holding shift or using /ns on a map.',
	'Mapflag_nocommand'						=>	'Disabled everyone to use special commands on a map.',
	'Mapflag_pvp'							=>	'Enables Player vs. Player mode on a map and applies the corresponding damage adjustments.',
	'Mapflag_pvp_noparty'					=>	'Enables Player vs. Player mode on a map and applies the corresponding damage adjustments (ignored party alliances).',
	'Mapflag_pvp_noguild'					=>	'Enables Player vs. Player mode on a map and applies the corresponding damage adjustments (ignored guild alliances).',
	'Mapflag_pvp_nocalcrank'				=>	'Enables Player vs. Player mode on a map and applies the corresponding damage adjustments (disabled calculation of PvP rankings).',
	'Mapflag_pvp_nightmaredrop'				=>	'Players droped special items upon death.',
	'Mapflag_gvg'							=>	'Enables Guild vs. Guild mode on a map and applies the corresponding damage adjustments.',
	'Mapflag_gvg_noparty'					=>	'Enables Guild vs. Guild mode on a map and applies the corresponding damage adjustments (ignore party alliances).',
	'Mapflag_gvg_castle'					=>	'Enables Guild vs. Guild mode on a map and applies the corresponding damage adjustments (guild castle).',
	'Mapflag_gvg_dungeon'					=>	'Enables Guild vs. Guild mode on a map and applies the corresponding damage adjustments (guild dungeon).',
	'Mapflag_gvg_te'						=>	'Enables Guild vs. Guild mode on a map and applies the corresponding damage adjustments (TE mode).',
	'Mapflag_gvg_te_castle'					=>	'Enables Guild vs. Guild mode on a map and applies the corresponding damage adjustments (TE castle).',
	'Mapflag_battleground'					=>	'Enables Battlegrounds on a map and applies the corresponding damage adjustments.',
	'Mapflag_partylock'						=>	'Prevents alteration of parties and guilds on a map (allowed change party options).',
	'Mapflag_guildlock'						=>	'Prevents alteration of parties and guilds on a map (allowed change guild alliances).',
	'Mapflag_skill_damage'					=>	'Some skills damage was changed on a map.',
	'Mapflag_skill_duration'				=>	'Some skills duration was changed on a map.',
	'Mapflag_clouds'						=>	'Have clouds effect.',
	'Mapflag_clouds2'						=>	'Have clouds effect.',
	'Mapflag_fireworks'						=>	'Have fireworks effect.',
	'Mapflag_fog'							=>	'Have fog effect.',
	'Mapflag_leaves'						=>	'Have leaves effect.',
	'Mapflag_sakura'						=>	'Have sakura effect.',
	'Mapflag_snow'							=>	'Have snow effect.',
	'Mapflag_nightenabled'					=>	'Night mode effects enabled on a map.',
	'Mapflag_town'							=>	'Is town.',
	'Mapflag_reset'							=>	'Allowed usage of item Neuralizer.',
	'Mapflag_bexp'							=>	'Have a custom base experience rate on a map.',
	'Mapflag_jexp'							=>	'Have a custom job experience rate on a map.',
	'Mapflag_loadevent'						=>	'Triggers the label "OnPCLoadMapEvent" when players enter a map.',
	'Mapflag_allowks'						=>	'Allowed kill stealing on a map.',
	'Mapflag_autotrade'						=>	'Allowed the @autotrade command on a map.',
	'Mapflag_nomapchannelautojoin'			=>	'Stops players from automatically joining the #map channel on a map.',
